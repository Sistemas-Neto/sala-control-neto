...
function SbItem({ label, id, active, onClick, badge }) {
  return (
    <div onClick={() => onClick(id)} style={{
      ...
      {badge > 0 && (
        <span style={{
          background:"#E24B4A", color:"#fff", fontSize:11,
...
const s = {
  ...
  sbTop:{padding:"18px 16px 14px"},
  sbLabel:{fontSize:12,color:"#85B7EB",letterSpacing:".08em",textTransform:"uppercase",fontWeight:500,marginBottom:3},
  sbTitle:{fontSize:17,fontWeight:500,color:"#fff",lineHeight:1.2},
  sbSub:{fontSize:13,color:"#85B7EB",marginTop:2},
  sbDiv:{height:"0.5px",background:"rgba(255,255,255,0.1)",margin:"0 14px"},
  sbNav:{padding:"10px 8px",flex:1},
  sbSec:{fontSize:12,color:"#85B7EB",letterSpacing:".06em",textTransform:"uppercase",padding:"8px 9px 3px",fontWeight:500},
  sbFoot:{padding:"12px 16px",borderTop:"0.5px solid rgba(255,255,255,0.1)",marginTop:"auto",display:"flex",alignItems:"center",gap:9},
  sbAv:{width:34,height:34,borderRadius:"50%",background:"#185FA5",display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,fontWeight:500,color:"#E6F1FB",flexShrink:0},
  sbName:{fontSize:14,color:"#fff",fontWeight:500},
  sbRole:{fontSize:12,color:"#85B7EB"},
  main:{flex:1,display:"flex",flexDirection:"column",minWidth:0},
  topbar:{background:"#fff",borderBottom:"0.5px solid #eee",padding:"10px 16px",display:"flex",alignItems:"center",gap:7,flexShrink:0},
  tbInfo:{flex:1},
  tbTitle:{fontSize:16,fontWeight:500,color:"#222"},
  ...
  bodyGrid:{display:"grid",gridTemplateColumns:"1fr 340px",gap:10},
  rightCol:{display:"flex",flexDirection:"column",gap:9,minWidth:0},
  mini:{background:"#fff",border:"0.5px solid #eee",borderRadius:10,padding:"14px 16px"},
  miniTitle:{fontSize:15,fontWeight:500,color:"#555",marginBottom:10},
  roomRow:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"7px 0",borderBottom:"0.5px solid #eee"},
  rrName:{fontSize:14,color:"#222"},
  badge:{fontSize:12,padding:"3px 9px",borderRadius:10,fontWeight:500},
  ...
  nr:{padding:"9px 11px",background:"#f8f8f8",borderRadius:8,cursor:"pointer",marginBottom:5},
  nrT:{fontSize:14,fontWeight:500,color:"#222"},
  nrM:{fontSize:12,color:"#888",marginTop:2},
  msg:{padding:20,textAlign:"center",color:"#888",fontSize:14},
  card:{background:"#fff",border:"0.5px solid #eee",borderRadius:10,padding:"16px 18px"},
  cardTitle:{fontSize:16,fontWeight:500,color:"#222",marginBottom:13},
  roomGrid:{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:9},
  roomCard:{background:"#f8f8f8",borderRadius:8,padding:"12px 14px"},
  roomName:{fontSize:14,fontWeight:500,color:"#222"},
  roomMeta:{fontSize:12,color:"#888",marginTop:4},
  secTitle:{fontSize:13,fontWeight:500,color:"#888",textTransform:"uppercase",letterSpacing:".06em",marginBottom:9,paddingBottom:7,borderBottom:"0.5px solid #eee"},
  repRow:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"11px 13px",background:"#f8f8f8",borderRadius:8,marginBottom:7},
  repName:{fontSize:14,fontWeight:500,color:"#222"},
  dlBtns:{display:"flex",gap:6},
  dlXl:{padding:"6px 11px",border:"0.5px solid #1D6F42",borderRadius:6,fontSize:12,color:"#1D6F42",background:"none",cursor:"pointer"},
  dlPdf:{padding:"6px 11px",border:"0.5px solid #A32D2D",borderRadius:6,fontSize:12,color:"#A32D2D",background:"none",cursor:"pointer"},
  dlCsv:{padding:"6px 11px",border:"0.5px solid #185FA5",borderRadius:6,fontSize:12,color:"#185FA5",background:"none",cursor:"pointer"},
  tbl:{width:"100%",borderCollapse:"collapse",fontSize:14},
  th:{textAlign:"left",padding:"9px 11px",fontSize:13,fontWeight:500,color:"#888",borderBottom:"0.5px solid #eee"},
  td:{padding:"9px 11px",borderBottom:"0.5px solid #eee",color:"#222"},
  fgrid:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:9},
  formSecTitle:{fontSize:13,fontWeight:500,color:"#888",marginBottom:8,paddingBottom:6,borderBottom:"0.5px solid #eee"},
  fl:{fontSize:12,color:"#888",marginBottom:3},
  fi:{width:"100%",padding:"8px 11px",border:"0.5px solid #ddd",borderRadius:6,fontSize:14,boxSizing:"border-box"},
};
